...
assert.ok(source.includes('downloadAdditionSubtractionWorksheetPdf(state.currentSet)'));
assert.ok(source.includes("state.currentSet.type === 'addition-subtraction'"));
assert.ok(source.includes("els.downloadPdf.textContent = t('creatingPdf');"));
assert.ok(source.includes("els.downloadPdf.textContent = t('downloadWorksheetPdf');"));
...
assert.ok(html.includes('Creating PDF...'));
